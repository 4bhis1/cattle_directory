      ...
      >
        <Box className="max-w-7xl mx-auto px-6 py-4">
          <Box className="flex items-center justify-between mb-4">
            <Box className="flex gap-4 md:gap-8 overflow-x-auto">
              <Box>
                <Typography variant="caption" className="text-gray-500 uppercase tracking-wider font-bold">Morning</Typography>
                <Typography variant="h6" className="text-blue-600 font-bold">{totalMorning.toFixed(1)} <span className="text-sm text-gray-400">kg</span></Typography>
              </Box>
              <Box>
                <Typography variant="caption" className="text-gray-500 uppercase tracking-wider font-bold">Evening</Typography>
                <Typography variant="h6" className="text-purple-600 font-bold">{totalEvening.toFixed(1)} <span className="text-sm text-gray-400">kg</span></Typography>
              </Box>
              <Box>
                <Typography variant="caption" className="text-gray-500 uppercase tracking-wider font-bold">Cost</Typography>
                <Typography variant="h6" className="text-green-600 font-bold">₹{totalCost.toFixed(0)}</Typography>
              </Box>
            </Box>
          </Box>
          ...
          >
            {loading ? 'Saving...' : 'Save Feed Records'}
          </Button>
        </Box>
      </Paper>
